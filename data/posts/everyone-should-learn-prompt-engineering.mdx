...
## Non-Technical Users
The average person should learn prompt engineering to use LLMs more effectively. Even simple Persona patterns of prompting (e.g., `You're an expert marker. Write me some marketing copy for X.`) can make a LLM far more effective than a raw, basic prompt (`Write me some marketing copy for X`).
...
As of right now I don't think so. I think it will definitely change a lot, and some techniques will become unnecessary as models become more intuitive.
